...
exports.onGroupConversationUpdated = exports.onConversationUpdated = exports.onConversationsCreated = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
admin.initializeApp();
exports.onConversationsCreated = functions.firestore.document("conversations/{conversationsID}").onCreate((snapshot, context) => {
...
exports.onConversationUpdated = functions.firestore.document("conversations/{conversationsID}").onUpdate((change, context) => {
    ...
    if (data) {
        ...
        const idTo = members.filter((u) => u !== idFrom);
        ...
        snapshot.docs.forEach(function (child) {
            ...
            for (let index = 0; index < participants.length; index++) {
                ...
                docRef.get().then(function (_snapshot) {
                    ...
                    let lst = userData === null || userData === void 0 ? void 0 : userData.categoryLevels;
                    let found = false;
                    ...
                    let exp = userData === null || userData === void 0 ? void 0 : userData.exp;
...
exports.onGroupConversationUpdated = functions.firestore.document("groupConversations/{conversationsID}").onUpdate((change, context) => {
    let data = change === null || change === void 0 ? void 0 : change.after.data();
    let conversationID = context.params.conversationsID;
    if (data) {
        let lastMessage = data.messages[data.messages.length - 1];
        ...
        return admin.firestore().doc(`users/${idFrom}/events/self/Current/${conversationID}`).get().then(_event => {
            admin.firestore().doc(`users/${idFrom}`).get().then(_userFrom => {
                var _a, _b;
                let userName = (_a = _userFrom.data()) === null || _a === void 0 ? void 0 : _a.displayName;
                let eventName = (_b = _event.data()) === null || _b === void 0 ? void 0 : _b.name;
